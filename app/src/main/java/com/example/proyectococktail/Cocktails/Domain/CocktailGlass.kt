...
/**
 * Esta clase representa un caso de uso para obtener un cóctel en copa de cocktail.
 * @param repository el repositorio que proporciona la funcionalidad para obtener el cóctel aleatorio.
 */
class CocktailGlass @Inject constructor(private val repository: Repository) {
    suspend operator fun invoke(): CocktailState {
        return repository.vCocktailGlass()
    }
}
